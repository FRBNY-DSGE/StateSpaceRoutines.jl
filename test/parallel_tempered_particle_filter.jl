using JLD, JLD2, Test, Distributions, Random, StateSpaceRoutines, BenchmarkTools, ParallelDataTransfer, FLoops
...
sendto(workers(), s_init = s_init)
sendto(workers(), F_ϵ = F_ϵ)
sendto(workers(), F_u = F_u)

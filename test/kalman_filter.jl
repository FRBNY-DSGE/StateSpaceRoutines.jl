...
@test_approx_eq read(h5, "zend")          out[2]
@test_approx_eq read(h5, "Pend")          out[3]
...
@test_approx_eq read(h5, "filt")          out[10]
@test_approx_eq read(h5, "vfilt")         out[11]
close(h5)
...
@test_approx_eq     read(h5, "L")             out[1]
@test_approx_eq     read(h5, "zend")          out[2]
@test_approx_eq_eps read(h5, "Pend")          out[3]  1e-1
@test_approx_eq     read(h5, "pred")          out[4]
@test_approx_eq_eps read(h5, "vpred")         out[5]  1e-1
@test_approx_eq     read(h5, "yprederror")    out[6]
@test_approx_eq     read(h5, "ystdprederror") out[7]
@test_approx_eq     read(h5, "rmse")          out[8]
@test_approx_eq     read(h5, "rmsd")          out[9]
@test_approx_eq     read(h5, "filt")          out[10]
@test_approx_eq_eps read(h5, "vfilt")         out[11] 1e-1
close(h5)
